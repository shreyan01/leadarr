...
def build_email_prompt(inputs: EmailInputs) -> str:
    ...
    return (
        ...
        "You may wrap at most 2-3 short key phrases in **double asterisks** for bold emphasis "
        "(e.g. the business name once, or the single most important finding) — this renders as "
        "real bold text in the final email. Use it sparingly; a paragraph that's mostly bold "
        "reads as spammy, not professional. Single *asterisks* render as italic if you need "
        "lighter emphasis. Don't use any other markdown or formatting syntax.\n\n"
        f"AUDIT FINDINGS:\n{findings_block}\n\n"
